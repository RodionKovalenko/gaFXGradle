...
public class Mnist {
    ...
    public static String projectPath = "src\\main\\java\\org\\openjfx";

    public static int[][][] getMnistTrainData() throws Exception {
        MnistMatrix[] trainMatrix = new MnistDataReader().readData(
                workingDir + projectPath + "\\gaJava\\mnist\\data\\train-images.idx3-ubyte",
                workingDir + projectPath +"\\gaJava\\mnist\\data\\train-labels.idx1-ubyte");
    ...
    public static int[][][] getMnistTestData() throws Exception {
        MnistMatrix[] testMatrix = new MnistDataReader().readData(
                workingDir + projectPath + "\\gaJava\\mnist\\data\\t10k-images.idx3-ubyte",
                workingDir + projectPath + "\\gaJava\\mnist\\data\\t10k-labels.idx1-ubyte");
